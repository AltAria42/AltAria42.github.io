...
- **Flèche bas / haut** (selon navigateur) : faire défiler la page  
...
- des sections (H2),  
- des sous-sections (H3).  

Les images possèdent une alternative textuelle lorsqu’elles apportent une information utile.
